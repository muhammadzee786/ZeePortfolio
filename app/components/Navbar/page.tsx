...
function Navbar() {
     ...
     return (
       <nav className="flex items-center justify-between flex-wrap p-6" style={{backgroundColor:'red'}}>
         ...
         <div className="block lg:hidden" style={{backgroundColor: "gray"}}>
           <button
         ...
         >
           <div className={`text-sm lg:flex-grow text-base font-medium ${styles.linkColor}`}>
             <Link href="/Home" className="block mt-4 lg:inline-block lg:mt-0 mr-4">
               Home
             </Link>
